...
class Config:
   def __init__(self):
      ...
      self.threshold = 0.55       # Threshold for bbox confidence to pass (used in visualisation and metrics).
      self.threshold_iou = 0.3  # Threshold for IOU between duplicates, if iou > th then drop bbox with smaler confident.
      ...
      self.train_base = True        # Unlock all layers for training?
      self.load_checkpoint = True   # Load checkpoint from {self.checkpoint_name}
